...
cors_regex = r"https://([a-z0-9_-]+\.)?(ashes\.live|onrender\.com)|https?://(localhost|192\.168\.\d+\.\d+):300[0-9]"
...
app.include_router(views.comments.router, prefix="/v2", tags=["comments"])
...
app.include_router(views.subscriptions.router, prefix="/v2", tags=["subscriptions"])
